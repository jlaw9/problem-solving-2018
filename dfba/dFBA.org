...
#+BEGIN_SRC ipython :session :exports both :results raw drawer :async t
  ...
  def defineDFBAModel(SpeciesDict , MediaDF):
      ...
      for species in SpeciesDict.keys():
          ...
          VarDef[Name] =  'mu_' + Name + ' * ' + Name + ' - ' + 'Dilution * ' + Name + '- K_diff *' + Name ### Biomass, 20% diffuse to mucosa
...
#+BEGIN_SRC ipython :session :exports both :results raw drawer :async t
    ...
    Output, SpecieDict, ModDefinition = simulateCommunity(SpeciesDict, MediaDF, MaxIter=50)
#+END_SRC
...
:RESULTS:
# Out[88]:
[[file:./obipy-resources/29743erf.png]]
:END:
