...
#+BEGIN_SRC ipython :session :exports both :results raw drawer :async t
  ...
  #defineDFBAModel(SpeciesDict , Diet, cobraonly=True)
  Output, SpecDict, modDef = simulator.simulateCommunity(SpeciesDict, Diet, MaxIter=5,cobraonly=True)
  #SpeciesDict, ModelDef, ModelDS = simulator.defineDFBAModel(SpeciesDict , Diet, cobraonly=False)
  #ModelDef
#+END_SRC
...
#+BEGIN_SRC ipython :session :exports both :results raw drawer :async t
  for k in ModelDef.varspecs.keys():
      if 'EX' not in k and 'DM' not in k:
          print(k, ModelDef.varspecs[k])
  #ModelDef.varspecs['Shigella_flexneri_M']
#+END_SRC
...
:RESULTS:
# Out[3]:
[[file:./obipy-resources/58118LR.png]]
:END:
