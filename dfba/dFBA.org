...
* Testing Integrated model
 #+BEGIN_SRC ipython :session :exports both :results raw drawer :async t
   ...
   Output, SpecDict, modDef = simulator.simulateCommunity(SpeciesDict, Diet, MaxIter=1)
   xsimulator.plotBiomass( SpecDict, Output)
#+END_SRC

#+RESULTS:
:RESULTS:
0 - 53816e5e-b534-4479-8be3-2c39536c586f
:END:
#+BEGIN_SRC ipython :session :exports both :results raw drawer :async t
  P=[]
  t=[]
...
#+RESULTS:
:RESULTS:
0 - a22004a4-3d92-4922-ada2-42cf4bedcf93
:END:
